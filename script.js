document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(5) hue-rotate(-45deg) brightness(1.5) contrast(2.5)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(5) hue-rotate(-45deg) brightness(1.5) contrast(2.5)'; // Adjusted filter values
    }
