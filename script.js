document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(70) hue-rotate(-25deg) brightness(0.7) contrast(1.3)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(70) hue-rotate(-25deg) brightness(0.7) contrast(1.3)'; // Adjusted filter values
    }
