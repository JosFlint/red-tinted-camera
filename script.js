document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(5) hue-rotate(-65deg) brightness(0,9) contrast(2.5)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(5) hue-rotate(-65deg) brightness(0.9) contrast(2.5)'; // Adjusted filter values
    }
